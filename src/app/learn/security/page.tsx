...
import {
  ...
  Activity, Code2, Mail, Key, Fingerprint, ShieldAlert, UserCheck, KeyRound, Smartphone,
  HardDrive, CloudOff, Ban, ShieldX, Brain, Atom, Sparkles as SparklesIcon,
  Target, ShieldCheck, FileCheck, Hash, Wallet, AlertTriangle, Coins, FileText, Eye
} from "lucide-react";
import { motion } from "framer-motion";

export default function SecurityCoursePage() {
  const course = getCourseById("security");
