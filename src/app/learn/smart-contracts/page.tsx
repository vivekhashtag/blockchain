      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            <span className="px-6 py-2 rounded-full bg-gradient-to-r from-red-100 to-pink-100 text-red-900 text-base md:text-lg sm:text-xl md:text-2xl font-semibold">
              {course.difficulty}
            </span>
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 leading-relaxed max-w-5xl">
            {course.description}
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 text-white text-3xl font-bold shadow-xl">
              I
            </div>
            <div>
          ...
          <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 xl:p-12 mb-6 md:mb-8 lg:mb-12 border-2 border-blue-200">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-300">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-300">
                <div className="flex items-center gap-3 mb-6">
          ...
          <div className="mb-12">
            <h3 className="text-5xl font-bold text-gray-900 mb-4 md:mb-6 lg:mb-8 flex items-center gap-4">
              <Target className="w-12 h-12 text-blue-600" />
              What is a Smart Contract?
            </h3>

            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 xl:p-12 text-white mb-8">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-200 shadow-lg">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-200 shadow-lg">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-teal-200 shadow-lg">
          ...
          <div className="mb-12">
            ...
            <p className="text-base sm:text-base md:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8">
              ...
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-red-300">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">No Decentralized Execution</p>
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">No Immutable Storage</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Trust Required</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">No Native Digital Assets</p>
                      <p className="text-base md:text-lg text-gray-700">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-green-300">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Decentralized Execution</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Immutable Code</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Trustless Execution</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Native Cryptocurrency</p>
                      <p className="text-base md:text-lg text-gray-700">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-8">
              {/* Level 1: Simple */}
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-green-500">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="bg-white rounded-xl p-6 border border-green-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: ERC-20 Token</p>
                        <p className="text-base text-gray-700">
                          Standardized token contract with functions like transfer(), balanceOf(), and approve().
                        </p>
                      </div>
                      <div className="bg-white rounded-xl p-6 border border-green-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Multi-Signature Wallet</p>
                        <p className="text-base text-gray-700">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-yellow-500">
                <div className="flex items-start gap-6">
                  <div className="flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="bg-white rounded-xl p-6 border border-yellow-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Compound Finance</p>
                        <p className="text-base text-gray-700">
                          Algorithmic money market where users lend/borrow crypto with dynamic interest rates.
                        </p>
                      </div>
                      <div className="bg-white rounded-xl p-6 border border-yellow-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Uniswap V2</p>
                        <p className="text-base text-gray-700">
              ...
              {/* Level 3: Complex */}
              <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-orange-500">
                <div className="flex items-start gap-6">
                  <div className="flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="bg-white rounded-xl p-6 border border-orange-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: MakerDAO</p>
                        <p className="text-base text-gray-700">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-orange-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Aave</p>
                        <p className="text-base text-gray-700">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-purple-500">
                <div className="flex items-start gap-6">
                  <div className="flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="bg-white rounded-xl p-6 border border-purple-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Synthetix</p>
                        <p className="text-base text-gray-700">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-purple-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Yearn Finance</p>
                        <p className="text-base text-gray-700">
          ...
          {/* Key Takeaway */}
          <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
        ...
        >
          {/* Part Header */}
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-purple-500 to-pink-600 text-white text-3xl font-bold shadow-xl">
              II
            </div>
            <div>
              <h2 className="text-6xl font-bold text-gray-900 mb-2">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              {/* Step 1: Creation */}
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-blue-500">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-blue-300">
                      <p className="text-base md:text-lg font-mono text-gray-800 mb-3">
    ...
    function get() public view returns (uint256) {
        return storedData;
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-green-500">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div className="bg-white rounded-xl p-6 border border-green-300">
                        <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Transaction Flow:</p>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-yellow-300">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-yellow-300 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="text-base md:text-lg text-gray-700">Addition (ADD)</span>
                    <span className="font-mono font-bold text-yellow-700">3 gas</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="text-base md:text-lg text-gray-700">Multiplication (MUL)</span>
                    <span className="font-mono font-bold text-yellow-700">5 gas</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="text-base md:text-lg text-gray-700">Store 256 bits (SSTORE)</span>
                    <span className="font-mono font-bold text-yellow-700">20,000 gas</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="text-base md:text-lg text-gray-700">Create contract</span>
                    <span className="font-mono font-bold text-yellow-700">32,000+ gas</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-3">
                    <span className="text-base md:text-lg text-gray-700">ERC-20 transfer</span>
                    <span className="font-mono font-bold text-yellow-700">~21,000-60,000 gas</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-base md:text-lg text-gray-700">Uniswap swap</span>
                    <span className="font-mono font-bold text-yellow-700">~150,000 gas</span>
                  </div>
                </div>
              </div>

              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-orange-300 shadow-lg">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <div className="space-y-6">
                  <div className="bg-orange-50 rounded-xl p-6 border border-orange-300">
                    <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3">Formula:</p>
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-300">
                    <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3">Real Example:</p>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-300">
              <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              ...
              <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 border border-blue-200">
                  ...
                  <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Minimize Storage</p>
                  <p className="text-base text-gray-700">
                ...
                <div className="bg-white rounded-xl p-6 border border-blue-200">
                  <CheckCircle2 className="w-8 h-8 text-green-600 mb-3" />
                  <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Batch Operations</p>
                  <p className="text-base text-gray-700">
                ...
                <div className="bg-white rounded-xl p-6 border border-blue-200">
                  <CheckCircle2 className="w-8 h-8 text-green-600 mb-3" />
                  <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Use Events, Not Storage</p>
                  <p className="text-base text-gray-700">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-teal-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="bg-white rounded-xl p-4 border border-green-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Price Feeds</p>
                      <p className="text-base text-gray-700">
                        ETH/USD, BTC/USD, AAPL/USD updated every ~1 minute. Used by Aave, Synthetix, dYdX.
                      </p>
                    </div>
                    <div className="bg-white rounded-xl p-4 border border-green-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">VRF (Verifiable Random Function)</p>
                      <p className="text-base text-gray-700">
                        Provably fair randomness for NFT minting, gaming, lotteries.
                      </p>
                    </div>
                    <div className="bg-white rounded-xl p-4 border border-green-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Any API</p>
                      <p className="text-base text-gray-700">
            ...
            {/* Real Example */}
            <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-teal-300 shadow-lg">
              <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl p-6 border border-teal-300">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-base md:text-lg text-gray-800">Smart contract created with policy terms</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold">2</div>
                      <p className="text-base md:text-lg text-gray-800">Chainlink oracle monitors FlightStats API</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold">3</div>
                      <p className="text-base md:text-lg text-gray-800">Flight delayed 4 hours → Oracle updates contract</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold">4</div>
                      <p className="text-base md:text-lg text-gray-800">Contract automatically pays $500 to your wallet</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-purple-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
            ...
            {/* Flash Loans Example */}
            <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-purple-300 shadow-xl mb-8">
              <h4 className="text-4xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <Zap className="w-12 h-12 text-purple-600" />
                Composability in Action: Flash Loans
              </h4>

              <p className="text-base sm:text-base md:text-lg md:text-xl lg:text-2xl text-gray-700 mb-4 md:mb-6 lg:mb-8 leading-relaxed">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-200 mb-8">
                <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-6">Transaction Flow (all in one TX):</p>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-base md:text-lg font-semibold text-gray-900">Borrow</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-base md:text-lg font-semibold text-gray-900">Arbitrage</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-base md:text-lg font-semibold text-gray-900">Repay + Fee</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-base md:text-lg font-semibold text-gray-900">Profit</p>
              ...
              <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div className="bg-green-50 rounded-xl p-6 border-2 border-green-300">
                  <CheckCircle2 className="w-8 h-8 text-green-600 mb-3" />
                  <p className="text-base md:text-lg font-bold text-gray-900 mb-2">Use Cases</p>
                ...
                <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-300">
                  ...
                  <p className="text-base md:text-lg font-bold text-gray-900 mb-2">Protocols Offering</p>
                  <ul className="text-base text-gray-700 space-y-2">
                    <li>• Aave ($13B TVL)</li>
                    <li>• dYdX</li>
                    <li>• Balancer</li>
                ...
                <div className="bg-purple-50 rounded-xl p-6 border-2 border-purple-300">
                  ...
                  <p className="text-base md:text-lg font-bold text-gray-900 mb-2">Volume</p>
                  <p className="text-base text-gray-700">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-300">
              <h4 className="text-3xl font-bold text-gray-900 mb-6">The DeFi Stack: Protocols Building on Protocols</h4>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold text-xl">1</div>
                  <div className="flex-1">
                    <p className="text-xl font-bold text-gray-900 mb-2">Base Layer: Lending (Compound, Aave)</p>
                    <p className="text-base md:text-lg text-gray-700">Supply USDC, earn 3% APY</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-purple-500 text-white flex items-center justify-center font-bold text-xl">2</div>
                  <div className="flex-1">
                    <p className="text-xl font-bold text-gray-900 mb-2">Aggregation Layer: Yearn Finance</p>
                    <p className="text-base md:text-lg text-gray-700">Automatically moves your USDC between Compound/Aave for best rate → 4.5% APY</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-pink-500 text-white flex items-center justify-center font-bold text-xl">3</div>
                  <div className="flex-1">
                    <p className="text-xl font-bold text-gray-900 mb-2">Derivative Layer: Convex Finance</p>
                    <p className="text-base md:text-lg text-gray-700">Boosts Yearn returns by staking LP tokens → 7% APY + governance tokens</p>
                  </div>
                </div>
              </div>
          ...
          {/* Key Takeaway */}
          <div className="bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
              <Brain className="w-16 h-16 flex-shrink-0" />
              <div>
        ...
        >
          {/* Part Header */}
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-red-500 to-orange-600 text-white text-3xl font-bold shadow-xl">
              III
            </div>
            <div>
              <h2 className="text-6xl font-bold text-gray-900 mb-2">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-red-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-green-300 shadow-lg">
                <div className="flex items-center gap-3 mb-6">
                  <CheckCircle2 className="w-10 h-10 text-green-600" />
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Offer & Acceptance</p>
                      <p className="text-base md:text-lg text-gray-700">One party proposes terms, the other accepts. ✅ Smart contracts meet this.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Consideration</p>
                      <p className="text-base md:text-lg text-gray-700">Something of value exchanged (money, tokens). ✅ Smart contracts facilitate this.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Intention to Create Legal Relations</p>
                      <p className="text-base md:text-lg text-gray-700">Parties intend to be legally bound. ⚠️ Can be ambiguous with code.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Certainty & Completeness</p>
                      <p className="text-base md:text-lg text-gray-700">Terms must be clear and complete. ✅ Code is deterministic.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-yellow-300 shadow-lg">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Interpretation</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="w-6 h-6 text-yellow-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Capacity & Consent</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="w-6 h-6 text-yellow-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Enforceability</p>
                      <p className="text-base md:text-lg text-gray-700">
                  ...
                  <div className="flex items-start gap-3">
                    <AlertTriangle className="w-6 h-6 text-yellow-600 flex-shrink-0 mt-1" />
                    <div>
                      <p className="text-base md:text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">Jurisdiction</p>
                      <p className="text-base md:text-lg text-gray-700">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-8">
              {/* Challenge 1 */}
              <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-red-500">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                  <XCircle className="w-10 h-10 text-red-600" />
              ...
              {/* Challenge 2 */}
              <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-orange-500">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="bg-white rounded-xl p-6 border border-orange-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Example: Fraud</p>
                    <p className="text-base text-gray-700">
                  ...
                  <div className="bg-white rounded-xl p-6 border border-orange-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Example: Mistake</p>
                    <p className="text-base text-gray-700">
              ...
              {/* Challenge 3 */}
              <div className="bg-gradient-to-r from-yellow-50 to-green-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-yellow-500">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-300 shadow-lg">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-300 shadow-lg">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-pink-300 shadow-lg">
            ...
            <div className="mt-8 bg-red-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-red-300">
          ...
          {/* Key Takeaway */}
          <div className="bg-gradient-to-br from-red-600 via-orange-600 to-yellow-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
              <Brain className="w-16 h-16 flex-shrink-0" />
              <div>
        ...
        >
          {/* Part Header */}
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-green-500 to-teal-600 text-white text-3xl font-bold shadow-xl">
              IV
            </div>
            <div>
              <h2 className="text-6xl font-bold text-gray-900 mb-2">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-green-50 via-teal-50 to-blue-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-green-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
              ...
              <p className="text-base sm:text-base md:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mt-4">
            ...
            {/* Emerging Solutions */}
            <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-green-300 shadow-xl">
              <h4 className="text-4xl font-bold text-gray-900 mb-4 md:mb-6 lg:mb-8 flex items-center gap-3">
              ...
              <div className="space-y-8">
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-purple-500">
                  ...
                  <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl p-6 border border-purple-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: Civic</p>
                      <p className="text-base text-gray-700">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-purple-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Example: BrightID</p>
                      <p className="text-base text-gray-700">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-blue-500">
                  ...
                  <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl p-6 border border-blue-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Chainalysis</p>
                      <p className="text-base text-gray-700">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-blue-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">TRM Labs</p>
                      <p className="text-base text-gray-700">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-l-8 border-green-500">
                  ...
                  <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl p-6 border border-green-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Coinbase DeFi Wallet</p>
                      <p className="text-base text-gray-700">
                        Users verify identity when converting fiat ↔ crypto. Once funds are on-chain, they can interact with DeFi freely.
                      </p>
                    </div>
                    <div className="bg-white rounded-xl p-6 border border-green-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Compound Treasury</p>
                      <p className="text-base text-gray-700">
          ...
          <div className="mb-12">
            ...
            {/* The Audit Process */}
            <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-blue-300 shadow-xl mb-8">
            ...
            {/* Top Audit Firms */}
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-300 mb-8">
          ...
          {/* Key Takeaway */}
          <div className="bg-gradient-to-br from-green-600 via-teal-600 to-blue-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
              <Brain className="w-16 h-16 flex-shrink-0" />
              <div>
        ...
        >
          {/* Part Header */}
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 text-white text-3xl font-bold shadow-xl">
              V
            </div>
            <div>
              <h2 className="text-6xl font-bold text-gray-900 mb-2">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-cyan-50 via-blue-50 to-purple-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-cyan-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-cyan-300 shadow-xl">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-6">
                ...
                <div className="bg-cyan-50 rounded-xl p-6 border-2 border-cyan-300">
                  <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Example: OlympusDAO (3,3)</p>
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              ...
              {/* Real-World Assets */}
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-blue-300 shadow-xl">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 md:p-8 mb-6 border-2 border-blue-300">
                  <p className="text-2xl font-bold text-gray-900 mb-4">
                    Why RWAs Matter: Unlocking $16 Trillion Market
                  </p>
                  <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Benefits for TradFi:</p>
                    ...
                    <div>
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Benefits for DeFi:</p>
                      <ul className="space-y-2 text-base text-gray-700">
              ...
              {/* Institutional DeFi */}
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-purple-300 shadow-xl">
                <h4 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                  <Users className="w-10 h-10 text-purple-600" />
                  3. Institutional DeFi
                </h4>

                <p className="text-xl text-gray-700 mb-4 md:mb-6 lg:mb-8 leading-relaxed">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-blue-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-red-300 shadow-lg">
          ...
          {/* Key Takeaway */}
          <div className="bg-gradient-to-br from-cyan-600 via-blue-600 to-purple-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
              <Brain className="w-16 h-16 flex-shrink-0" />
              <div>
        ...
        >
          {/* Part Header */}
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 text-white text-3xl font-bold shadow-xl">
              VI
            </div>
            <div>
              <h2 className="text-6xl font-bold text-gray-900 mb-2">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-orange-300">
              <p className="text-3xl font-bold text-gray-900 mb-6">
            ...
            <div className="space-y-8">
              ...
              {/* Financial Inclusion */}
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-teal-300 shadow-xl">
                <h4 className="text-4xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 rounded-xl p-6 md:p-8 mb-6 border-2 border-teal-300">
                  ...
                  <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="bg-red-50 rounded-lg p-6 border-2 border-red-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Traditional (Western Union, MoneyGram):</p>
                      <ul className="space-y-2 text-base text-gray-700">
                    ...
                    <div className="bg-green-50 rounded-lg p-6 border-2 border-green-300">
                      <p className="text-base md:text-lg font-semibold text-gray-900 mb-3">Smart Contract (Stellar, Ripple):</p>
                      <ul className="space-y-2 text-base text-gray-700">
          ...
          <div className="bg-yellow-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-yellow-300">
          ...
          {/* Key Takeaway */}
          <div className="mt-12 bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
              <Brain className="w-16 h-16 flex-shrink-0" />
              <div>
        ...
        >
          {/* Part Header */}
          <div className="flex items-center gap-4 md:gap-6 mb-12">
            <div className="flex items-center justify-center w-20 h-20 rounded-xl md:rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white text-3xl font-bold shadow-xl">
              VII
            </div>
            <div>
              <h2 className="text-6xl font-bold text-gray-900 mb-2">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-blue-300 shadow-lg">
                ...
                <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Stablecoins</p>
                    <p className="text-base text-gray-700">Must hold reserves, get licensed. USDT/USDC comply or face bans.</p>
                  </div>
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">DeFi Protocols</p>
                  ...
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Consumer Protection</p>
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-300 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="bg-purple-50 rounded-xl p-4 border border-purple-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">SEC Approach: Most Tokens Are Securities</p>
                    <p className="text-base text-gray-700">
                      Ripple, Coinbase, Binance sued. Howey Test applied. BTC/ETH likely commodities, most altcoins = securities.
                    </p>
                  </div>
                  <div className="bg-purple-50 rounded-xl p-4 border border-purple-300">
                    <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">Potential Legislation: FIT21, DCCPA</p>
                    <p className="text-base text-gray-700">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-cyan-600 via-blue-600 to-purple-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 xl:p-12 text-white">
              <p className="text-4xl font-bold mb-8">
                Smart contracts represent a fundamental reimagining of how agreements work.
              </p>
              <div className="space-y-6 text-base sm:text-base md:text-lg md:text-xl lg:text-2xl leading-relaxed">
                <p>
          ...
          {/* Key Takeaway */}
          <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 text-white">
            <div className="flex items-start gap-6">
              <Brain className="w-16 h-16 flex-shrink-0" />
              <div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <div className="bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 xl:p-12 text-white text-center shadow-2xl">
            <div className="text-8xl mb-6">🎉</div>
            <h2 className="text-6xl font-bold mb-6">Course Complete!</h2>
            <p className="text-3xl mb-4 md:mb-6 lg:mb-8 leading-relaxed max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center text-base sm:text-base md:text-lg md:text-xl lg:text-2xl mb-8">
              <div className="bg-white/20 backdrop-blur-sm rounded-xl md:rounded-2xl px-8 py-4">
                ✅ Understanding Smart Contracts
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-xl md:rounded-2xl px-8 py-4">
            ...
            <div className="flex gap-4 md:gap-6 justify-center flex-wrap">
              <Link
                href="/learn"
                className="inline-block rounded-xl bg-white text-purple-600 px-4 py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-3 md:px-8 md:py-4 lg:px-10 lg:py-5 text-2xl font-semibold hover:bg-gray-100 transition-all"
              >
                ← Back to Courses
              </Link>
              <Link
                href="/learn/advanced"
                className="inline-block rounded-xl bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-3 md:px-8 md:py-4 lg:px-10 lg:py-5 text-2xl font-semibold hover:from-yellow-500 hover:to-orange-600 transition-all"
              >
