      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        >
          ...
          <div className="mb-16">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-blue-200">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-green-300">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-red-300">
            ...
            <div className="bg-blue-50 rounded-xl p-6 md:p-8 border-l-4 border-blue-600">
          ...
          <div className="mb-16">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-purple-200">
              <p className="text-2xl text-gray-800 leading-relaxed mb-6">
            ...
            <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-green-300">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-8">
            ...
            <div className="bg-yellow-50 rounded-xl p-6 md:p-8 border-l-4 border-yellow-500 mb-8">
          ...
          <div className="mb-16">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-indigo-200">
              <p className="text-2xl text-gray-800 leading-relaxed mb-6">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-indigo-500 text-white flex items-center justify-center text-2xl font-bold">
                  1
                </div>
            ...
            <div className="bg-blue-50 rounded-xl p-6 md:p-8 border-l-4 border-blue-600 mb-8">
            ...
            <div className="bg-red-50 rounded-xl p-6 md:p-8 border-2 border-red-300 mb-8">
            ...
            <div className="bg-green-50 rounded-xl p-6 md:p-8 border-2 border-green-300">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-teal-300">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-orange-300">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-pink-300">
            ...
            <div className="bg-gradient-to-br from-purple-50 via-blue-50 to-teal-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-purple-300">
          ...
          {/* Key Takeaways */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
        ...
        >
          ...
          <div className="mb-16">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-red-300">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-green-300">
          ...
          <div className="mb-16">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-yellow-300">
              <p className="text-2xl text-gray-800 leading-relaxed mb-6">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-yellow-500 text-white flex items-center justify-center text-2xl font-bold">
                  1
                </div>
            ...
            <div className="bg-purple-50 rounded-xl p-6 md:p-8 border-2 border-purple-300 mb-8">
            ...
            <div className="bg-green-50 rounded-xl p-6 md:p-8 border-2 border-green-300 mb-8">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-8">
              <div className="bg-red-50 rounded-xl p-6 border-2 border-red-300">
                ...
                <p className="text-base md:text-lg text-gray-700">Need to lock up Bitcoin in channels, reducing liquidity</p>
              </div>
              <div className="bg-red-50 rounded-xl p-6 border-2 border-red-300">
                <h5 className="text-xl font-bold text-red-700 mb-3">Offline Partners</h5>
                <p className="text-base md:text-lg text-gray-700">If channel partner goes offline, funds temporarily stuck</p>
              </div>
              <div className="bg-red-50 rounded-xl p-6 border-2 border-red-300">
                <h5 className="text-xl font-bold text-red-700 mb-3">Routing Challenges</h5>
                <p className="text-base md:text-lg text-gray-700">Large payments difficult if channels lack capacity</p>
              </div>
              <div className="bg-red-50 rounded-xl p-6 border-2 border-red-300">
                <h5 className="text-xl font-bold text-red-700 mb-3">Always Online</h5>
                <p className="text-base md:text-lg text-gray-700">Need to be online to receive payments (unlike on-chain)</p>
              </div>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-8">
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-orange-300">
                ...
                <div className="bg-orange-50 rounded-lg p-4 mb-4">
                  <p className="text-base md:text-lg text-gray-700"><strong>Leaders:</strong> Arbitrum, Optimism</p>
                  <p className="text-base md:text-lg text-gray-700"><strong>Daily Volume:</strong> Billions of dollars</p>
                </div>
                <div className="bg-red-50 rounded-lg p-4">
                  <p className="text-base md:text-lg text-red-700"><strong>Trade-off:</strong> 7-day waiting period to withdraw to Layer 1 (time for fraud proofs)</p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-300">
                ...
                <div className="bg-purple-50 rounded-lg p-4 mb-4">
                  <p className="text-base md:text-lg text-gray-700"><strong>Leaders:</strong> zkSync, StarkNet</p>
                  <p className="text-base md:text-lg text-gray-700"><strong>Advantage:</strong> No withdrawal delay!</p>
                </div>
                <div className="bg-yellow-50 rounded-lg p-4">
                  <p className="text-base md:text-lg text-yellow-700"><strong>Challenge:</strong> More complex to build, limited smart contract support currently</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-blue-300">
          ...
          <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-indigo-200">
            ...
            <div className="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-green-300 mb-8">
              ...
              <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-green-50 rounded-lg p-4 text-center">
                  ...
                  <p className="text-base md:text-lg text-gray-700">Daily Volume</p>
                </div>
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <p className="text-4xl font-bold text-blue-600 mb-2">Low Fees</p>
                  <p className="text-base md:text-lg text-gray-700">Pennies per tx</p>
                </div>
                <div className="bg-purple-50 rounded-lg p-4 text-center">
                  <p className="text-4xl font-bold text-purple-600 mb-2">Fast</p>
                  <p className="text-base md:text-lg text-gray-700">2-second blocks</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 rounded-xl p-6 md:p-8 border-2 border-red-300 mb-8">
              ...
              <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-6">
                  ...
                  <p className="text-base md:text-lg text-gray-700 mb-2"><strong>$625 million</strong> stolen</p>
                ...
                <div className="bg-white rounded-lg p-6">
                  ...
                  <p className="text-base md:text-lg text-gray-700 mb-2"><strong>$326 million</strong> stolen</p>
            ...
            <div className="bg-blue-50 rounded-xl p-6 md:p-8 border-l-4 border-blue-600 mb-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-base md:text-lg text-gray-800">Use official bridges maintained by chain developers, not third-party solutions</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 text-xl">•</span>
                  <span className="text-base md:text-lg text-gray-800">Require more confirmations for smaller chains to reduce attack profitability</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 text-xl">•</span>
                  <span className="text-base md:text-lg text-gray-800">Implement multi-signature requirements and time delays for large withdrawals</span>
                </li>
              </ul>
            </div>
          ...
          {/* Key Takeaways */}
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
            <h4 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <Brain className="h-8 w-8" />
        ...
        >
          ...
          <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-6 md:mb-8 lg:mb-12 border-2 border-green-300">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8">
              <div className="bg-white rounded-xl p-6 border-2 border-blue-300">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Dominates Ethereum development. JavaScript-like but statically typed.</p>
              ...
              <div className="bg-white rounded-xl p-6 border-2 border-orange-300">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Used by Solana, Polkadot, Near. Safer but steeper learning curve.</p>
              ...
              <div className="bg-white rounded-xl p-6 border-2 border-purple-300">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Vyper: Python-like, simpler. Move: Assets as first-class resources.</p>
                <p className="text-base text-gray-600">Each makes different trade-offs for safety vs features.</p>
              </div>
            </div>

            <div className="bg-white rounded-xl p-6 md:p-8 border-2 border-green-300">
              <h4 className="text-2xl font-bold text-green-700 mb-4">Development Tools</h4>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-green-600 text-xl">•</span>
                  <span className="text-base md:text-lg text-gray-800"><strong>Remix IDE:</strong> Browser-based, perfect for learning</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 text-xl">•</span>
                  <span className="text-base md:text-lg text-gray-800"><strong>Hardhat/Truffle:</strong> Professional frameworks with testing & deployment</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 text-xl">•</span>
                  <span className="text-base md:text-lg text-gray-800"><strong>Ganache:</strong> Local blockchain for testing</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 text-xl">•</span>
                  <span className="text-base md:text-lg text-gray-800"><strong>Security Tools:</strong> Slither, MythX scan for vulnerabilities</span>
                </li>
              </ul>
          ...
          <div className="bg-gradient-to-r from-green-600 to-teal-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
            <h4 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <Brain className="h-8 w-8" />
        ...
        >
          ...
          <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-12">
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-indigo-300">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-white rounded-lg p-4">
                  <p className="text-base md:text-lg font-bold text-gray-800 mb-2">Bitcoin: Modest Requirements</p>
                  <p className="text-base text-gray-600">2GB RAM, 500GB storage, decent internet. Could run on Raspberry Pi ($50)!</p>
                </div>
                <div className="bg-white rounded-lg p-4">
                  <p className="text-base md:text-lg font-bold text-gray-800 mb-2">Ethereum: More Demanding</p>
                  <p className="text-base text-gray-600">16GB RAM, 2TB+ fast SSD. State grows as smart contracts store data.</p>
                </div>
                <div className="bg-white rounded-lg p-4">
                  <p className="text-base md:text-lg font-bold text-gray-800 mb-2">Solana: Extreme</p>
                  <p className="text-base text-gray-600">128GB RAM, NVMe SSDs, gigabit internet. Performance = expensive nodes.</p>
                </div>
              </div>

              <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
                <p className="text-base md:text-lg text-gray-800"><strong>Why Run a Node?</strong> Privacy, sovereignty, contribute to decentralization!</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-purple-300">
              ...
              <div className="bg-white rounded-xl p-6 mb-6 border-2 border-purple-200">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Download only block headers (80 bytes/block), not entire blockchain.</p>
              ...
              <div className="bg-white rounded-xl p-6 border-2 border-blue-200">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Infura, Alchemy, QuickNode—the unsung heroes making blockchain accessible!</p>
          ...
          <div className="bg-blue-50 rounded-xl p-6 md:p-8 border-2 border-blue-300 mb-12">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg p-6">
                ...
                <p className="text-base md:text-lg text-gray-700">Files split into chunks, distributed across peers, retrieved by content hash.</p>
              ...
              <div className="bg-white rounded-lg p-6">
                ...
                <p className="text-base md:text-lg text-gray-700">Someone must "pin" (store) files. Services like Pinata ensure NFTs don't disappear.</p>
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
            <h4 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <Brain className="h-8 w-8" />
        ...
        >
          ...
          <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-12">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-3">Like arcade tokens—give access to a service.</p>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-3">Voting power in protocols. Like voting shares.</p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-3">Traditional securities on blockchain.</p>
              <p className="text-base text-gray-600"><strong>Heavily regulated:</strong> Selling unregistered = massive fines/charges</p>
            </div>
          </div>

          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-6 md:mb-8 lg:mb-12 border-2 border-red-300">
            <h3 className="text-4xl font-bold text-red-700 mb-6">⚠️ Tokenomics Design: Make or Break</h3>
            <p className="text-2xl text-gray-800 mb-4 md:mb-6 lg:mb-8 leading-relaxed">
          ...
          <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-12">
            <div className="bg-blue-50 rounded-xl p-6 md:p-8 border-2 border-blue-300">
              <h3 className="text-3xl font-bold text-blue-700 mb-6">DEX vs CEX</h3>
              <div className="space-y-4">
                <div className="bg-white rounded-lg p-4">
                  <h4 className="text-base md:text-lg font-bold text-blue-700 mb-2">CEX (Binance, Coinbase)</h4>
                  <p className="text-sm text-gray-700">✓ Better prices, faster, easier. ✗ Require KYC, can freeze funds, risk hacks/insolvency (FTX!)</p>
                </div>
                <div className="bg-white rounded-lg p-4">
                  <h4 className="text-base md:text-lg font-bold text-purple-700 mb-2">DEX (Uniswap, Sushiswap)</h4>
          ...
          <div className="bg-gradient-to-r from-yellow-600 to-orange-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
            <h4 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <Brain className="h-8 w-8" />
        ...
        >
          ...
          <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-red-300">
            ...
            <div className="bg-yellow-50 rounded-xl p-6 border-l-4 border-yellow-500">
              ...
              <p className="text-base md:text-lg text-gray-700">When loans become under-collateralized, whoever liquidates first gets 5-10% bounty. Bots spend millions yearly in gas fees competing. Some bots pay $100K gas for $110K profit!</p>
            </div>
          </div>

          <div className="bg-gradient-to-r from-red-600 to-pink-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
        ...
        >
          ...
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 mb-4 md:mb-6 lg:mb-8 border-2 border-purple-300">
            ...
            <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-8">
              <div className="bg-white rounded-xl p-6 border-2 border-blue-300">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Zero-Knowledge Succinct Non-Interactive Arguments of Knowledge</p>
              ...
              <div className="bg-white rounded-xl p-6 border-2 border-purple-300">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-3">Scalable Transparent Arguments of Knowledge</p>
            ...
            <div className="bg-green-50 rounded-xl p-6 border-2 border-green-300">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-base md:text-lg text-gray-800"><strong>Privacy Coins:</strong> Monero (ring signatures), Zcash (zk-SNARKs for optional privacy)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600">•</span>
                  <span className="text-base md:text-lg text-gray-800"><strong>Private DeFi:</strong> Aztec Network (private trades/lending on Ethereum)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600">•</span>
                  <span className="text-base md:text-lg text-gray-800"><strong>Identity:</strong> Polygon ID (prove you're 21+ without revealing exact age)</span>
                </li>
              </ul>
            </div>
          </div>

          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
        ...
        >
          ...
          <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-12">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-300">
              <h3 className="text-2xl font-bold text-blue-700 mb-4">Hyperledger Fabric</h3>
              <p className="text-base md:text-lg text-gray-700 mb-3"><strong>IBM + Linux Foundation.</strong> Permissioned, channels for privacy.</p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-3"><strong>Built for banks.</strong> Not a blockchain—distributed ledger, transactions only involve relevant parties.</p>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-3"><strong>Quorum (JPMorgan).</strong> Private Ethereum with permissions.</p>
          ...
          <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
        ...
        >
          ...
          <div className="grid md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-12">
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-6 border-2 border-pink-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-4">Non-Fungible Tokens—unique digital ownership via ERC-721/1155 standards.</p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-4">Read-Write-Own. Users control data, identity, value creation.</p>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6 border-2 border-purple-300">
              ...
              <p className="text-base md:text-lg text-gray-700 mb-4">Decentralized Autonomous Organizations—coordinate without corporations via token voting.</p>
          ...
          <div className="bg-gradient-to-r from-pink-600 to-rose-600 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
        ...
        >
          ...
          <div className="space-y-8 mb-12">
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-red-300">
              ...
              <div className="bg-white rounded-xl p-6 mb-6">
                ...
                <div className="space-y-2">
                  <p className="text-base md:text-lg text-gray-700">1️⃣ Large UST sales broke $1 peg</p>
                  <p className="text-base md:text-lg text-gray-700">2️⃣ Users rushed to redeem UST for LUNA</p>
                  <p className="text-base md:text-lg text-gray-700">3️⃣ Massive LUNA minting crashed price</p>
                  <p className="text-base md:text-lg text-gray-700">4️⃣ LUNA supply: 350M → <strong className="text-red-600">6.5 TRILLION</strong> in 3 days (hyperinflation!)</p>
                  <p className="text-base md:text-lg text-gray-700">5️⃣ Total collapse. Suicides reported. 😢</p>
                </div>
              </div>
              <div className="bg-yellow-50 rounded-lg p-4 border-l-4 border-yellow-500">
                <p className="text-base md:text-lg text-gray-800"><strong>Lessons:</strong> Algorithmic stability extremely difficult. Recursive systems fragile. Anchor's 20% yields unsustainable. High yields often hide problems.</p>
              </div>
            </div>

            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-orange-300">
              ...
              <div className="bg-white rounded-xl p-6 mb-6">
                ...
                <ul className="space-y-2">
                  <li className="text-base md:text-lg text-gray-700">• FTX created backdoors allowing Alameda unlimited margin (infinite customer money!)</li>
                  <li className="text-base md:text-lg text-gray-700">• Alameda positions exempt from liquidation—accumulated billions in losses</li>
                  <li className="text-base md:text-lg text-gray-700">• FTT token used as collateral despite being printed by FTX</li>
                  <li className="text-base md:text-lg text-gray-700">• When Binance's CZ tweeted about selling FTT → bank run → <strong className="text-red-600">$8B missing</strong></li>
                </ul>
              </div>
              <div className="bg-yellow-50 rounded-lg p-4 border-l-4 border-yellow-500">
                <p className="text-base md:text-lg text-gray-800"><strong>Lessons:</strong> "Not your keys, not your coins." Regulatory arbitrage enables fraud. Celebrity endorsements ≠ legitimacy. Complexity hides fraud. Crypto doesn't eliminate traditional financial crimes.</p>
              </div>
            </div>

            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 border-2 border-purple-300">
              ...
              <div className="bg-red-50 rounded-lg p-4 mt-6 border-l-4 border-red-500">
                <p className="text-base md:text-lg text-gray-800"><strong>Pattern:</strong> Over $2B stolen in bridge hacks. Every major hack preventable with known best practices—but pressure to ship fast overrides security.</p>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-r from-gray-800 to-black rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-10 text-white">
            <h4 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <Brain className="h-8 w-8" />
        ...
        >
          <div className="bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 rounded-xl md:rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 xl:p-12 text-white text-center shadow-2xl">
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center mb-4 md:mb-6 lg:mb-8 text-xl">
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
              ...
              <Link
                href="/"
                className="inline-block rounded-xl bg-gradient-to-r from-yellow-400 to-orange-400 text-gray-900 px-4 py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-3 md:px-8 md:py-4 lg:px-10 lg:py-5 text-2xl font-semibold hover:from-yellow-500 hover:to-orange-500 transition-all"
              >
                🏠 Home
              </Link>
            </div>
            ...
            <div className="mt-12 pt-12 border-t border-white/30">
              <p className="text-base sm:text-base md:text-lg md:text-xl lg:text-2xl mb-4">🎓 All 6 Courses Complete!</p>
