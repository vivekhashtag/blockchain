    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-8 sm:px-10 lg:px-16">
          ...
          >
            <div className="text-center p-8 rounded-2xl bg-white shadow-xl border border-gray-200">
              <CheckCircle className="w-12 h-12 mx-auto mb-4 text-green-600" />
              <div className="text-2xl font-bold text-gray-900 mb-2">No Installation</div>
              <div className="text-gray-600 text-lg">Run directly in your browser</div>
            </div>
            <div className="text-center p-8 rounded-2xl bg-white shadow-xl border border-gray-200">
              <Zap className="w-12 h-12 mx-auto mb-4 text-blue-600" />
              <div className="text-2xl font-bold text-gray-900 mb-2">Real-time Results</div>
              <div className="text-gray-600 text-lg">See instant feedback</div>
            </div>
            <div className="text-center p-8 rounded-2xl bg-white shadow-xl border border-gray-200">
              <Play className="w-12 h-12 mx-auto mb-4 text-purple-600" />
              <div className="text-2xl font-bold text-gray-900 mb-2">Learn by Doing</div>
              <div className="text-gray-600 text-lg">Practice makes perfect</div>
            </div>
          </motion.div>
        </div>
      </section>
                  ...
                  <Link href={tool.href}>
                    <div className="group relative overflow-hidden rounded-2xl bg-white border-2 border-gray-200 hover:border-blue-400 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
                      ...
                      <div className="relative p-8">
                        <div className={`w-16 h-16 bg-gradient-to-r ${tool.color} rounded-xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                        ...
                        <div className="flex items-center text-blue-600 text-lg font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                          Try it now
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-5xl mx-auto px-8 sm:px-10 lg:px-16">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="text-center p-12 bg-white rounded-3xl shadow-2xl border-2 border-gray-200"
          >
            ...
            <Link
              href="/learn"
              className="inline-flex items-center px-10 py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 text-xl shadow-xl"
            >
              Back to Courses
            </Link>
          </motion.div>
