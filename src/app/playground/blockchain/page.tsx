...
export default function BlockchainVisualizerPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 py-20 md:py-24">
          ...
          <AnimatePresence mode="wait">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-300 shadow-xl">
                  ...
                  <div className="bg-white rounded-xl p-6 border-2 border-purple-400 mb-6">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900">Genesis Block</h3>
            ...
            {currentStep === "mempool" && pendingTransaction && (
              <motion.div
                ...
                className="space-y-8"
              >
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 border-2 border-yellow-300 shadow-xl">
                  ...
                  <div className="bg-white rounded-xl p-6 border-2 border-yellow-400 mb-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900">Pending Transaction</h3>
                    </div>
                  ...
                  {!isMining && !newBlock && (
                    <div className="bg-white rounded-xl p-6 border-2 border-orange-400 mb-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900">Ready to Mine</h3>
                      </div>
                  ...
                  {isMining && (
                    <div className="bg-white rounded-xl p-6 border-2 border-orange-400 mb-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900">Mining in Progress...</h3>
                      </div>
                      <div className="mb-4">
                  ...
                  {newBlock && (
                    <div className="bg-white rounded-xl p-6 border-2 border-green-400 mb-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-2xl font-bold text-green-900">Block Mined Successfully!</h3>
                      </div>
                      <div className="space-y-3">
                        <div className="p-3 bg-gray-50 rounded-lg">
            ...
            {currentStep === "validation" && newBlock && (
              ...
              >
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-300 shadow-xl">
                  ...
                  <div className="bg-white rounded-xl p-6 border-2 border-green-400 mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Validation Checks:</h3>
                  ...
                  {!isValid && (
                    <div className="p-6 bg-red-100 rounded-xl border-2 border-red-400 mb-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          <h3 className="text-2xl font-bold text-red-900 mb-2">❌ Chain Invalid!</h3>
                  ...
                  {isValid && (
                    <div className="p-6 bg-green-100 rounded-xl border-2 border-green-400 mb-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          <h3 className="text-2xl font-bold text-green-900 mb-2">✅ Chain Still Valid</h3>
